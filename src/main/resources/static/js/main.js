$(document).ready(function() {
	...
	$('#page-welcome').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.profile-nav, .skills-nav, .education-nav, .experience-nav, .portfolio-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 51
	});
	...
	$('#page-profile .container').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.welcome-nav, .skills-nav, .education-nav, .experience-nav, .portfolio-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-skills .container').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.profile-nav, .welcome-nav, .education-nav, .experience-nav, .portfolio-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-education .container').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.skills-nav, .profile-nav, .welcome-nav, .experience-nav, .portfolio-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-experience .container').waypoint(function(direction) {
		if(direction == 'down') {	
			...
			$('.skills-nav, .profile-nav, .welcome-nav, .education-nav, .portfolio-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-portfolio .container').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.skills-nav, .profile-nav, .welcome-nav, .education-nav, .experience-nav, .contact-nav, .blog-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-blog .container').waypoint(function(direction) {
		if(direction == 'down') {
			...
			$('.skills-nav, .profile-nav, .welcome-nav, .education-nav, .experience-nav, .contact-nav, .portfolio-nav').css('color','');
		}
	},{
		offset : 71
	});
	...
	$('#page-contact').waypoint(function() {
			...
			$('.skills-nav, .profile-nav, .welcome-nav, .education-nav, .experience-nav, .portfolio-nav, .blog-nav').css('color','');
	},{
